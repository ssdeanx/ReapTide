...
pub const ISO_CAMERA_HEIGHT: f32 = 600.0; // Camera Y elevation above ground
pub const ENTITY_HEIGHT: f32 = 0.5; // Y position for ground-based entities
pub const GROUND_SIZE: f32 = 5000.0; // Ground plane half-size
...
pub const CHARACTERS: &[CharacterDef] = &[
    ...
    CharacterDef {
        id: "harbinger",
        name: "Harbinger",
        desc: "Heavy damage, shorter reach",
        speed: 250.0,
        max_hp: 80.0,
        attack_damage: 28.0,
        attack_range: 140.0,
...
pub const ACHIEVEMENTS: &[AchievementDef] = &[
    ...
    AchievementDef {
        id: "wave_10",
        name: "Tidal Wave",
        desc: "Survive 10 waves",
        reward: 250,
    },
    AchievementDef {
        id: "collector",
        name: "Collector",
        desc: "Unlock 3 upgrades",
        reward: 400,
    },
    AchievementDef {
        id: "rich",
        name: "Soul Hoarder",
        desc: "Earn 1000 total currency",
        reward: 500,
    },
];
